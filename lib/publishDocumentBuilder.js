...
const publishSections = [
  { heading: '2. Article Prompt', filename: 'article.prompt.md' },
  { heading: '3. Thumbnail Prompt', filename: 'thumbnail.prompt.md' },
  { heading: '4. Infographic 1', filename: 'infographic-01.prompt.md' },
  { heading: '5. Infographic 2', filename: 'infographic-02.prompt.md' },
  { heading: '6. SEO', filename: 'seo.prompt.md' },
  { heading: '7. SEO Package', filename: 'seo-package.prompt.md' },
  { heading: '8. Tags', filename: 'tags.prompt.md' },
];
 ...
 */
function buildPublishDocument({ prompts, review, articleBrief }) {
  if (typeof articleBrief !== 'string' || !articleBrief.trim()) {
    throw new Error('Cannot build publish document: missing approved Article Brief.');
  }
  ...
  sections.unshift(`## 1. Article Brief\n\n${articleBrief}`);
  sections.push(`## 9. Review\n\n${review}`);
