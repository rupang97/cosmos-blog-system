...
Square 1024x1024 Korean lifestyle infographic about the first half of air-conditioner odor management. Render these exact Korean text elements inside the image: headline "에어컨 냄새, 먼저 확인"; steps "1 냄새 나는 시점 확인", "2 필터 먼지 제거", "3 내부 건조 기능 확인". Use a clear three-step flow with air-conditioner, clock, filter, and water-drop icons. Use high-contrast navy Korean typography on a white and sky-blue background, with generous whitespace for one-screen mobile and desktop viewing. Do not add, omit, translate, or alter any text. No logos, watermark, or unsupported claims.

## 인포그래픽 2 프롬프트

Square 1024x1024 Korean lifestyle infographic about the second half of air-conditioner odor management. Render these exact Korean text elements inside the image: headline "반복되는 냄새 관리"; steps "4 실내 습기 함께 관리", "5 반복되면 점검 요청"; footer "필터 청소는 시작입니다". Use a clear two-step flow with humidity, airflow, and service-check icons. Use high-contrast navy Korean typography on a white and sky-blue background, with generous whitespace for one-screen mobile and desktop viewing. Do not add, omit, translate, or alter any text. No logos, watermark, or unsupported claims.
