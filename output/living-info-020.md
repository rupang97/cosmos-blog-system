...
Minimal Korean lifestyle infographic about air-conditioner odor management. Use a clear Korean headline: "에어컨 냄새 관리" and a benefit subheadline: "필터·습기·내부 건조 확인". Present five numbered, scannable labels with simple air-conditioner, filter, water-drop, and airflow icons: "냄새 나는 시점 확인", "필터 먼지 제거", "내부 건조 기능 확인", "습기 환경 함께 관리", "반복되면 점검 요청". Use high-contrast Korean typography, clear visual hierarchy, generous whitespace for mobile viewing, and a clean blue-and-white palette. Use only these exact text phrases; do not add unsupported claims. If Korean text cannot be rendered accurately, create the layout without text and use the listed phrases as overlay copy. Vertical composition.
